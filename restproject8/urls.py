"""restproject8 URL Configuration
...
from restapp8.views import ProductApiView,HomeView,InputView,InsertInput,InserView,DisplayView,DeleteInputView,DeleteView,UpdateInputView,UpdateView
urlpatterns = [
